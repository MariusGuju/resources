...
FinanceOffice1 = {
	...
	FinanceOffice1.Swag.Enable(FinanceOffice1.Swag.BoozeCigs.A, true)
	FinanceOffice1.Swag.Enable(FinanceOffice1.Swag.DrugStatue.A, true)
	FinanceOffice1.Swag.Enable(FinanceOffice1.Swag.Electronic.A, true)
	FinanceOffice1.Swag.Enable(FinanceOffice1.Swag.Gems.A, true)
	FinanceOffice1.Swag.Enable(FinanceOffice1.Swag.Guns, true)
	FinanceOffice1.Swag.Enable(FinanceOffice1.Swag.Jewel.A, true)
	FinanceOffice1.Swag.Enable(FinanceOffice1.Swag.Silver.A, true)
	FinanceOffice1.Swag.Enable(FinanceOffice1.Swag.Counterfeit.A, true)
