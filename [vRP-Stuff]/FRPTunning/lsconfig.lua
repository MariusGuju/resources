...
------Neon layout------
	neonlayout = {
		{name = "Front,Back and Sides", price = 2300},
	},
	--Neon color
	neoncolor = {
		{ name = "White", neon = {255,255,255}, price = 200},
		{ name = "Blue", neon = {0,0,255}, price = 200},
		{ name = "Electric Blue", neon = {0,150,255}, price = 200},
		...
		{ name = "Red", neon = {255,0,0}, price = 200},
	...
	camber = {
		{ name = "Reseteaza Camber", colorindex = 0.0, price = 0,reset=true},
		{ name = "[+] 1", colorindex = 0.01, price = 0,reset=false},
		{ name = "[-] 1", colorindex = -0.01, price = 0,reset=false},
	},
	distantiere = {
		{ name = "Reseteaza Distantiere", colorindex = 0.0, price = 0,reset=true},
		{ name = "[+] 1", colorindex = -0.01, price = 0,reset=false},
		{ name = "[-] 1", colorindex = 0.01, price = 0,reset=false},
	},
...
----Wheel accessories----
	wheelaccessories = {
		{ name = "Stock Tires", price = 200},
		{ name = "Custom Tires", price = 700},
		{ name = "Bulletproof Tires", price = 1000},
		{ name = "White Tire Smoke",smokecolor = {254,254,254}, price = 250},
		{ name = "Black Tire Smoke", smokecolor = {1,1,1}, price = 250},
		{ name = "BLue Tire Smoke", smokecolor = {0,150,255}, price = 250},
		{ name = "Yellow Tire Smoke", smokecolor = {255,255,50}, price = 250},
		{ name = "Orange Tire Smoke", smokecolor = {255,153,51}, price = 250},
		{ name = "Red Tire Smoke", smokecolor = {255,10,10}, price = 250},
		{ name = "Green Tire Smoke", smokecolor = {10,255,10}, price = 250},
		{ name = "Purple Tire Smoke", smokecolor = {153,10,153}, price = 250},
		{ name = "Pink Tire Smoke", smokecolor = {255,102,178}, price = 250},
		{ name = "Gray Tire Smoke",smokecolor = {128,128,128}, price = 250},
	},
...
----Front wheel (Bikes)----
	frontwheel = {
		{name = "Stock", wtype = 6, mod = -1, price = 150},
		{name = "Speedway", wtype = 6, mod = 0, price = 100},
...
----Sport wheels-----
	sportwheels = {
		{name = "Stock", wtype = 0, mod = -1, price = 800},
		{name = "Inferno", wtype = 0, mod = 0, price = 800},
		{name = "Deepfive", wtype = 0, mod = 1, price = 800},
		{name = "Lozspeed", wtype = 0, mod = 2, price = 800},
		{name = "Diamondcut", wtype = 0, mod = 3, price = 800},
		{name = "Chrono", wtype = 0, mod = 4, price = 800},
		{name = "Feroccirr", wtype = 0, mod = 5, price = 800},
		{name = "Fiftynine", wtype = 0, mod = 6, price = 800},
		{name = "Mercie", wtype = 0, mod = 7, price = 800},
		{name = "Syntheticz", wtype = 0, mod = 8, price = 800},
		{name = "Organictyped", wtype = 0, mod = 9, price = 800},
		{name = "Endov1", wtype = 0, mod = 10, price = 800},
		{name = "Duper7", wtype = 0, mod = 11, price = 800},
		{name = "Uzer", wtype = 0, mod = 12, price = 800},
		{name = "Groundride", wtype = 0, mod = 13, price = 800},
		{name = "Spacer", wtype = 0, mod = 14, price = 800},
		{name = "Venum", wtype = 0, mod = 15, price = 800},
		{name = "Cosmo", wtype = 0, mod = 16, price = 800},
		{name = "Dashvip", wtype = 0, mod = 17, price = 800},
		{name = "Icekid", wtype = 0, mod = 18, price = 800},
		{name = "Ruffeld", wtype = 0, mod = 19, price = 800},
		{name = "Wangenmaster", wtype = 0, mod = 20, price = 800},
		{name = "Superfive", wtype = 0, mod = 21, price = 800},
		{name = "Endov2", wtype = 0, mod = 22, price = 800},
		{name = "Slitsix", wtype = 0, mod = 23, price = 800},
	},
-----Suv wheels------
	suvwheels = {
		{name = "Stock", wtype = 3, mod = -1, price = 800},
		{name = "Vip", wtype = 3, mod = 0, price = 800},
		{name = "Benefactor", wtype = 3, mod = 1, price = 800},
		{name = "Cosmo", wtype = 3, mod = 2, price = 800},
		{name = "Bippu", wtype = 3, mod = 3, price = 800},
		{name = "Royalsix", wtype = 3, mod = 4, price = 800},
		{name = "Fagorme", wtype = 3, mod = 5, price = 800},
		{name = "Deluxe", wtype = 3, mod = 6, price = 800},
		{name = "Icedout", wtype = 3, mod = 7, price = 800},
		{name = "Cognscenti", wtype = 3, mod = 8, price = 800},
		{name = "Lozspeedten", wtype = 3, mod = 9, price = 800},
		{name = "Supernova", wtype = 3, mod = 10, price = 800},
		{name = "Obeyrs", wtype = 3, mod = 11, price = 800},
		{name = "Lozspeedballer", wtype = 3, mod = 12, price = 800},
		{name = "Extra vaganzo", wtype = 3, mod = 13, price = 800},
		{name = "Splitsix", wtype = 3, mod = 14, price = 800},
		{name = "Empowered", wtype = 3, mod = 15, price = 800},
		{name = "Sunrise", wtype = 3, mod = 16, price = 800},
		{name = "Dashvip", wtype = 3, mod = 17, price = 800},
		{name = "Cutter", wtype = 3, mod = 18, price = 800},
	},
-----Offroad wheels-----
	offroadwheels = {
...
---------Headlights---------
	...
	[21] = {
		...
		{name = "Alb", mod = 0, price = 500},
		{name = "Albastru Inchis", mod = 1, price = 500},
		{name = "Albastru Deschis", mod = 2, price = 500},
		{name = "Turcoaz", mod = 3, price = 500},
		{name = "Verde", mod = 4, price = 500},
		{name = "Galben", mod = 5, price = 500},
		{name = "Auriu", mod = 6, price = 500},
		{name = "Portocaliu", mod = 7, price = 500},
		{name = "Rosu", mod = 8, price = 500},
		{name = "Roz", mod = 9, price = 500},
		{name = "Violet", mod = 10, price = 500},
		{name = "Purpuriu", mod = 11, price = 500},
		{name = "Ultra Violet", mod = 12, price = 500},
	},
...
-----------Armor-------------
	[16] = {
		{name = "Armor Upgrade 20%",modtype = 16, mod = 0, price = 500},
		{name = "Armor Upgrade 40%",modtype = 16, mod = 1, price = 1000},
		{name = "Armor Upgrade 60%",modtype = 16, mod = 2, price = 2500},
		{name = "Armor Upgrade 80%",modtype = 16, mod = 3, price = 3000},
		{name = "Armor Upgrade 100%",modtype = 16, mod = 4, price = 5500},
	},

---------Suspension-----------
	[15] = {
		{name = "Lowered Suspension",mod = 0, price = 700},
		{name = "Street Suspension",mod = 1, price = 1300},
		{name = "Sport Suspension",mod = 2, price = 2450},
		{name = "Competition Suspension",mod = 3, price = 5000},
	},

-----------Horn----------
	[14] = {
		{name = "Truck Horn", mod = 0, price = 125},
		{name = "Police Horn", mod = 1, price = 462},
		{name = "Clown Horn", mod = 2, price = 500},
		{name = "Musical Horn 1", mod = 3, price = 115},
		{name = "Musical Horn 2", mod = 4, price = 175},
		{name = "Musical Horn 3", mod = 5, price = 115},
		{name = "Musical Horn 4", mod = 6, price = 113},
		{name = "Musical Horn 5", mod = 7, price = 115},
		{name = "Sadtrombone Horn", mod = 8, price = 175},
		{name = "Calssical Horn 1", mod = 9, price = 175},
		{name = "Calssical Horn 2", mod = 10, price = 175},
		{name = "Calssical Horn 3", mod = 11, price = 175},
		{name = "Calssical Horn 4", mod = 12, price = 115},
		{name = "Calssical Horn 5", mod = 13, price = 375},
		{name = "Calssical Horn 6", mod = 14, price = 115},
		{name = "Calssical Horn 7", mod = 15, price = 115},
		{name = "Scaledo Horn", mod = 16, price = 115},
		{name = "Scalere Horn", mod = 17, price = 175},
		{name = "Scalemi Horn", mod = 18, price = 175},
		{name = "Scalefa Horn", mod = 19, price = 175},
		{name = "Scalesol Horn", mod = 20, price = 115},
		{name = "Scalela Horn", mod = 21, price = 135},
		{name = "Scaleti Horn", mod = 22, price = 137},
		{name = "Scaledo Horn High", mod = 23, price = 135},
		{name = "Jazz Horn 1", mod = 25, price = 117},
		{name = "Jazz Horn 2", mod = 26, price = 135},
		{name = "Jazz Horn 3", mod = 27, price = 115},
		{name = "Jazzloop Horn", mod = 28, price = 115},
		{name = "Starspangban Horn 1", mod = 29, price = 175},
		{name = "Starspangban Horn 2", mod = 30, price = 175},
		{name = "Starspangban Horn 3", mod = 31, price = 175},
		{name = "Starspangban Horn 4", mod = 32, price = 175},
		{name = "Classicalloop Horn 1", mod = 33, price = 175},
...
----------Transmission---------
	[13] = {
		{name = "Street Transmission", mod = 0, price = 2350},
		{name = "Sports Transmission", mod = 1, price = 4000},
		{name = "Race Transmission", mod = 2, price = 4500},
	},
...
-----------Brakes-------------
	[12] = {
		...
		{name = "Race Brakes", mod = 2, price = 5000},
	},
	
------------Engine----------
	[11] = {
		{name = "EMS Upgrade, Level 2", mod = 0, price = 4500},
		{name = "EMS Upgrade, Level 3", mod = 1, price = 5500},
		{name = "EMS Upgrade, Level 4", mod = 2, price = 7700},
	},
