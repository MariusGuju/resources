...
vRPserver = Tunnel.getInterface("vRP","vRP_weap")
vRPweap = Tunnel.getInterface("vRP_weap","vRP_weap")
vRPweapC = {}
Tunnel.bindInterface("vRP_weap",vRPweapC)
vRPserver = Tunnel.getInterface("vRP_weap","vRP_weap")
