...
Config.SafeMinimum = 3000
Config.SafeMax = 10000

Config.marker = { --Markers dos pontos de assalto
	idmarker = 27,x1 = 1.501,y1 = 1.5001,z1 = 0.5001,r = 255,g = 0,b = 0,a = 155,pula = 0,gira = 1  
}
...
Config.BankRobbery = {
    [1] = {
        ...
        BankName = 'Banca Centrala Pacific',
        iteme = {
            {"c4",4}
        }
    }
    --[[
    [2] = {
        Coods = vector3(308.06860351563,-281.62490844727,54.164653778076),
        Cops = 3,
        contador = 5000,
        Doors = { 
            {Coords = vector3(312.4, -282.7, 54.3), Object = "v_ilev_gb_vauldr", Heading = 250.0, OpenHeading = 155.0, Hacking = true, Time = 5, Frozen = true},
       },
        Safes = {},
        Money = {
            StartMoney = 100000,
            Amount = 100000,
            BoxPosition = vector3(312.97, -287.68, 53.95),
            Box = 'prop_cash_crate_01',
            Cam = {Coords = {x = 312.8, y = -288.51, z = 54.6}, Rotation = {rx = -35.0, ry = 0.0, rz = 335.0, r = 0}},
        },
        Hacking = {
            Coords = vector3(310.95,-284.3,54.16),
            Heading = 251.9,
        },
        BankName = 'Bank 2',
        iteme = {
    ...
    [3] = {
        Coods = vector3(-357.39825439453,-52.702217102051,49.036399841309),
        Cops = 3,
        contador = 5000,
        Doors = { 
            {Coords = vector3(-352.7, -53.6, 49.2), Object = "v_ilev_gb_vauldr", Heading = 251.0, OpenHeading = 155.0, Hacking = true, Time = 5, Frozen = true},
       },
        Safes = {},
        Money = {
            StartMoney = 100000,
            Amount = 100000,
            BoxPosition = vector3(-352.22, -58.31, 49.04),
            Box = 'prop_cash_crate_01',
            Cam = {Coords = {x = -352.0, y = -59.47, z = 49.73}, Rotation = {rx = -35.0, ry = 0.0, rz = 335.0, r = 0}},
        },
        Hacking = {
            Coords = vector3(-354.12,-55.2,48.04),
            Heading = 251.9,
        },
        BankName = 'Bank 3',
        iteme = {
    ...
    [4] = {
        Coods = vector3(143.61572265625,-1043.130859375,29.367923736572),
        Cops = 3,
        contador = 5000,
        Doors = { 
            {Coords = vector3(148.0, -1044.4, 29.5), Object = "v_ilev_gb_vauldr", Heading = 250.0, OpenHeading = 155.0, Hacking = true, Time = 5, Frozen = true},
       },
        Safes = {},
        Money = {
            StartMoney = 100000,
            Amount = 100000,
            BoxPosition = vector3(148.38, -1049.12, 29.20),
            Box = 'prop_cash_crate_01',
            Cam = {Coords = {x = 148.36, y = -1050.4, z = 30.38}, Rotation = {rx = -35.0, ry = 0.0, rz = 335.0, r = 0}},
        },
        Hacking = {
            Coords = vector3(146.61,-1045.99,29.37),
            Heading = 252.0,
        },
        Carrinhos = { 
            {Looted = false, Coords = vector3(146.9195098877,-1049.7504882813,29.346334457397), Coodsp = vector3(146.9195098877,-1049.7504882813,29.346334457397), Heading = 0.0},
            {Looted = false, Coords = vector3(149.74685668945,-1050.7895507813,29.346416473389), Coodsp = vector3(149.74685668945,-1050.7895507813,29.346416473389), Heading = 180.0}, 
         },
        BankName = 'Bank 4',
        iteme = {
            {"laptopHack",1}
    ...
    [5] = {
        Coods = vector3(-2958.1955566406,477.76760864258,15.696934700012),
        Cops = 3,
        contador = 5000,
        Doors = { 
            {Coords = vector3(-2958.5, 482.3, 15.5), Object = "v_ilev_gb_vauldr", Heading = 358.0, OpenHeading = 98.0, Hacking = true, Time = 5, Frozen = true},
       },
        Safes = {},
        Money = {
            StartMoney = 100000,
            Amount = 100000,
            BoxPosition = vector3(-2954.01, 484.81, 15.38),
            Box = 'prop_cash_crate_01',
            Cam = {Coords = {x = -2952.69, y = 484.7, z = 16.45}, Rotation = {rx = -35.0, ry = 0.0, rz = 85.0, r = 0}},
        },
        Hacking = {
            Coords = vector3(-2956.53,481.43,14.7),
            Heading = 1.5,
        },
        BankName = 'Bank 5',
        iteme = {
    ...
    [6] = {
        Coods = vector3(1180.2034912109,2711.33984375,38.087875366211),
        Cops = 3,
        contador = 5000,
        Doors = { 
            {Coords = vector3(1175.5,2710.9,38.2), Object = "v_ilev_gb_vauldr", Heading = 90.0, OpenHeading = 350.0, Hacking = true, Time = 5, Frozen = true},
       },
        Safes = {},
        Money = {
            StartMoney = 100000,
            Amount = 100000,
            BoxPosition = vector3(1173.4, 2715.22, 37.72),
            Box = 'prop_cash_crate_01',
            Cam = {Coords = {x = 1172.83, y = 2716.49, z = 38.47}, Rotation = {rx = -35.0, ry = 0.0, rz = 174.0, r = 0}},
        },
        Hacking = {
            Coords = vector3(1176.3,2712.84,38.09),
            Heading = 90.5,
        },
        BankName = 'Bank 6',
        iteme = {
