...
--]]
---1579.3385009766,-564.52905273438,108.52293395996,
cfg.slot_types = {
  ["meduza_smr"] = {
    {
      {"entry",-1289.8972167968,449.80038452148,97.902519226074},
      {"chest",-1567.7561035156,-586.88690185546,108.52299499512, _config = {weight=200}},
      {"wardrobe",-1565.0622558594,-572.15997314454,108.52297973632},
      {"gametable",-1571.8446044922,-586.40002441406,108.525390625},
      {"itemtr", _config = itemtr_study, -1283.2745361328,436.5560913086,97.694511413574 },
     -- {"itemtr", _config = itemtr_laboratory, -799.93286132813,187.0225982666,72.605445861816},
	  {"wardrobe",-1286.1696777344,438.0818786621,94.094833374024}
    }
  },
  ["la_familia"] = {
    {
      {"entry",1579.3385009766,-564.52905273438,108.52293395996,},
      {"chest",-1290.3385009766,432.86776733398,94.094856262208, _config = {weight=200}},
      {"wardrobe",-811.91864013672,175.12641906738,76.745376586914},
      {"gametable",-1285.1416015625,431.83963012696,97.522155761718 },
      {"itemtr", _config = itemtr_study, -1575.9006347656,-579.95867919922,108.52297973632 },
     -- {"itemtr", _config = itemtr_laboratory, -799.93286132813,187.0225982666,72.605445861816},
  ...
  ["mansion"] = {
    {
     ...
     -- {"itemtr", _config = itemtr_laboratory, -799.93286132813,187.0225982666,72.605445861816},
	  {"wardrobe",940.28094482422,1234.4107666016,366.11953735352}
    }
  },
  ["Modern_Apt"] = {
    {
  ...
  ["other_flat"] = {
    {
     ...
     -- {"itemtr", _config = itemtr_laboratory, -763.13397216796,327.33834838868,211.396484375}
    },
    {
...
cfg.homes = {
  ...
  ["La Familia Estate"] = {
    slot = "la_familia",
    entry_point = {-142.8649597168,-574.119140625,32.424488067626},
    buy_price = 9999999,
    sell_price = 0,
    max = 2,
    blipid=625,
  ...
  ["Str Meduzei Nr.3"] = {
    slot = "meduza_smr",
    entry_point = {902.98071289062,-615.65020751954,58.453338623046},
    buy_price = 500000,
    sell_price = 450000,
    max = 5,
    blipid=375,
  ...
  ["Lowside House"] = {
    slot = "franklin_house",
    entry_point = {-13.843015809753,-1444.6134033203,30.646482467651},
    buy_price = 400000,
    sell_price = 350000,
    max = 15,
    blipid=375,
  ...
  ["Basic Housing 2"] = {
   ...
   ["Basic Housing 3"] = {
    slot = "basic_flat",
    entry_point = {-1537.203491211,130.35215759278,57.37133026123},
    buy_price = 400000,
    sell_price = 350000,
    max = 15,
    blipid=375,
  ...
  ["Rich flat 2"] = {
    slot = "Rich_flat_2",
    entry_point = {-930.32800292968,19.39970779419,48.525775909424},
    buy_price = 500000,
    sell_price = 450000,
    max = 15,
    blipid=375,
  ...
  ["Expensive flat"] = { --hellsangels
    slot = "Expensive_flat",
    entry_point = {-113.42015075684,985.88708496094,235.75396728516},
    buy_price = 500000,
    sell_price = 450000,
    max = 15,
    blipid=375,
  ...
  ["Expensive Flat2"] = { --hellsangels
    slot = "Expensive_flat",
    entry_point = {-1549.3631591797,-90.606819152832,54.929172515869},
    buy_price = 500000,
    sell_price = 450000,
    max = 15,
    blipid=375,
