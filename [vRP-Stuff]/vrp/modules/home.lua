...
local function build_client_homes(source)
  ...
  if user_id ~= nil then
    for k,v in pairs(cfg.homes) do
      ...
      vRPclient.addMarkerNames(source,{x, y, z+ 0.65, "~b~[~w~INFO~b~]~w~: ~g~$"..v.buy_price.." ~w~ Vanzare: ~g~ $"..v.sell_price, 6, 1.0})
      vRPclient.addMarkerNames(source,{x, y, z+ 0.75, "~b~[~w~"..k.."~b~]", 1, 1.2})
