...
local cfg = module("vrp_display", "cfg/blips")
vRPidd = {}
IDDclient = Tunnel.getInterface("vrp_display","vrp_display")
vRPclient = Tunnel.getInterface("vRP","vrp_display")
Tunnel.bindInterface("vrp_display",vRPidd)
Proxy.addInterface("vrp_display",vRPidd)
