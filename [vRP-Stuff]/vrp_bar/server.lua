...
vRPclient = Tunnel.getInterface("vRP","vrp_bar")
PMclient = Tunnel.getInterface("vrp_bar","vrp_bar")
vRPpm = Tunnel.getInterface("vrp_bar","vrp_bar")
Tunnel.bindInterface("vrp_bar",vRPpm)
