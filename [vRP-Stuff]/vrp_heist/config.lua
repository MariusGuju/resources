...
Config.MissionNPC = {
	{
		--Pos = {x=3311.26,y=5176.45,z=19.61},
		Pos = {x=-567.27337646484,y=-442.61279296875,z=34.339977264404},	-- set NPC coords here 
		Heading = 360.39,							-- set heading of the NPC here
		Ped = 'a_m_m_eastsa_01'						-- set npc model name here
	},
}
...
Config.BlipNameOnMap = "Hot Masini"				-- set name of the blip
Config.BlipSprite = 616								-- set blip sprite, lists of sprite ids are here: https://docs.fivem.net/game-references/blips/
...
Config.BlipColour = 3								-- set blip color, list of colors available in the bottom of this link: https://docs.fivem.net/game-references/blips/
