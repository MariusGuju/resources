...
vRPclient = Tunnel.getInterface("vRP","SLASHERCore")
PMclient = Tunnel.getInterface("SLASHERCore","SLASHERCore")
vRPpm = Tunnel.getInterface("SLASHERCore","SLASHERCore")
Tunnel.bindInterface("SLASHERCore",vRPpm)
