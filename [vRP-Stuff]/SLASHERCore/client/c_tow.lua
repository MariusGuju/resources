local allowedTowModels = { 
    ...
    ['flatbed2'] = {x = 0.0, y = 0.0, z = 0.68},
    ['flatbed3'] = {x = 0.0, y = -1.2, z = 1.30},
}
	...
	if isVehicleTow then
		...
		Citizen.CreateThread(function()
			while true do
				...
				if IsEntityUpsidedown(GetVehiclePedIsIn(PlayerPedId(), true)) and isVehicleTow or roll > 1000.0 or roll < -1000.0 then
