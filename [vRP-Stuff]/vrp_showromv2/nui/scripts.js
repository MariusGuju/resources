...
function schimbaCategoria(categorieSelectata) {
    ...
    $.post('http://vrp_showromv2/changeCategory', JSON.stringify({categorieSelectata}));
...
function spawnMasina(idSelectie) {
    ...
    $.post('http://vrp_showromv2/spawnVehicle', JSON.stringify({idSelectie}));
...
function exitShowroom() {
    ...
    $.post('http://vrp_showromv2/exitshowroom', JSON.stringify({}));
...
function goBack(categorii) {
    ...
    $.post('http://vrp_showromv2/goBack', JSON.stringify({ categorii }));
...
function cumparaMasina() {
    ...
    $.post('http://vrp_showromv2/cumparaMasina', JSON.stringify({}));
...
function testeazaMasina() {
    ...
    $.post('http://vrp_showromv2/testeazaMasina', JSON.stringify({}));
...
function culoare(culoareselectata) {
	...
	$.post('http://vrp_showromv2/schimbaCuloare', JSON.stringify({culoareselectata}));
...
$(document).ready(function () {
    ...
    $("body").mousemove(function (a) {
        ...
        if (vehicleShopStartRotate) {
            ...
            $.post('http://vrp_showromv2/schimbaHeading', JSON.stringify({ h }));
