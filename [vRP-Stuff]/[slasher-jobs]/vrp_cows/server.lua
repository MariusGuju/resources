...
vRPclient = Tunnel.getInterface("vRP","vrp_cows")
Lclient = Tunnel.getInterface("vrp_cows","vrp_cows")
Tunnel.bindInterface("vrp_cows",vRPl)

cfg = module("vrp_cows", "cfg/config")
