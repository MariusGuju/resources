...
vRPserver = Tunnel.getInterface("vRP","vrp_def_menu")
HKserver = Tunnel.getInterface("vrp_keys","vrp_def_menu")
BMserver = Tunnel.getInterface("vrp_def_menu","vrp_def_menu")
