...
local iamasinainplm = {    
    ...
    {"720s","vip3.salariu","McLaren 720s VIP3"},
    ...
    {"cls2015","mofo.vehicle","Mercedes CLS 2016"},
    ...
    {"g65", "marchi.masina", "Masina MarchidanuBogdan"},
    {"bentayga17", "marchi.masina", "Masina MarchidanuBogdan#2"},      
    ...
    {"sanctus", "dallas.masina","Motor Dallas"},
    ...
    {"19raptor","remus.masina","Masina Personala Remus1"},
    {"bug300ss","flocea.masina","Masina Personala Flocea"},
    {"chino2","flocea.masina","Masina Flocea1"},
    {"Y1700MAX","zavy.masina","Motoreta Zavy"},
             --Mafia Mecanici--
    ...
    {"slsamg","cris.masina","Masina chris"},
    {"ccx","alexene.masina","Masina alexene"},           
