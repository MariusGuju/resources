...
vRPclient = Tunnel.getInterface("vRP","vrp_barber")

-- RESOURCE TUNNEL/PROXY
vRPbs = {}
Tunnel.bindInterface("vrp_barber",vRPbs)
Proxy.addInterface("vrp_barber",vRPbs)
vRPbsC = Tunnel.getInterface("vrp_barber","vrp_barber")

-- CFG
local cfg = module("vrp_barber", "cfg/barbershop")
