...
menu_options = {
    ...
    --{name = "Modele barbati", f = listModels, param = male_models},
    --{name = "Modele femei", f = listModels, param = female_models},
...
local clothing_shops = {
    {name="Magazin de Haine", id=73, x=428.45715332032, y=-799.92449951172, z=29.491130828858},
    {name="Magazin de Haine", id=73, x=1696.28125, y=4829.3125, z=42.063091278076},
    {name="Magazin de Haine", id=73, x=125.83, y=-223.16, z=54.55},
    {name="Magazin de Haine", id=73, x=-710.16, y=-153.26, z=37.41},
    {name="Magazin de Haine", id=73, x=-828.9580078125, y=-1074.3010253906, z=11.328104019166},
    {name="Magazin de Haine", id=73, x=-1192.81, y=-768.24, z=17.31},
    {name="Magazin de Haine", id=73, x=11.630876541138, y=6514.2841796875, z=31.877847671508},
    --{name="Magazin de Haine", id=73, x=425.471, y=-806.164, z=29.4911},
    {name="Magazin de Haine", id=73, x=105.53043365478, y=-1303.2395019532, z=28.76879119873},
    {name="Magazin de Haine", id=73, x=1707.4519042969, y=2568.8361816406, z=-69.411026000977},
    {name="", id=0, x=-2675.2895507813, y=1304.6096191406, z=152.01371765137},
    {name="", id=0, x=973.28228759766, y=-97.236938476562, z=74.870094299316},
    {name="", id=0, x=298.85894775391, y=-598.12683105469, z=43.284000396729},
    {name="Echipament Politie", id=60, x=461.12734985352, y=-998.93316650391, z=30.689504623413},
}
incircle = false
    ...
    while true do
        ...
        for k,v in ipairs(clothing_shops) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                DrawMarker(21, v.x, v.y, v.z - 0, 0, 0, 0, 0, 0, 0, 1.0001, 1.0001, 1.0001, 255, 0, 0,100, 20, 0, 2,1)
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
                    if (incircle == false) then
                        DisplayHelpText("Apasa ~INPUT_CONTEXT~ sa te imbraci.")
                    end
                    incircle = true
