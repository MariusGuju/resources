...
RC.resourcechecker = true -- Detects on Stopping/Starting resources that are not from your server (You can restart/stop/start resources but remember to do `refresh` in your console first)
...
-- Admin Menu Key
RC.client_AMKey = "insert"--false -- insert is the default key for the admin menu (set to false to disable and use command instead) -- chocoOpenMenu

-- Admin Menu Noclip Key
RC.client_AMnoclipKey = "f2" -- f2 is the default key for noclip (set to false to disable and use command instead) -- choconoclip

-- Client Side Weapons Settings
RC.client_checkWeapons = false -- Detects on holding a blacklisted Weapon (The check may be delayed by 5 seconds.)
