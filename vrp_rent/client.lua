...
Citizen.CreateThread(function()
  while true do
    ...
    text_overflow(pos.x,pos.y, pos.z + 1, "~g~Pret: ~r~50 $ ~w~| ~r~10 Minute")
...
AddEventHandler('vRP_Rent: spawncar', function()
  ...
  local vehicle = GetHashKey('sandero08')
...
AddEventHandler('vRP_Rent: message', function()
    ...
    AddTextComponentString("Ai inchiriat BMX pentru 10 minute")
    SetNotificationMessage("CHAR_CARSITE", "CHAR_CARSITE", true, 1, "BMX.ro | Cumpara acum!")
