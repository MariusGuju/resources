...
AddEventHandler("vlad:flip", function()
...
RegisterNetEvent("beny:sendPoliceChat")
AddEventHandler("beny:sendPoliceChat", function(name, msg)
  TriggerServerEvent("beny:recivePoliceChat", name, msg)
end) 
